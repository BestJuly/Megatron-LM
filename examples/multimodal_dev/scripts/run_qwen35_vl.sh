...
EXP_NAME="qwen35vl_${MODEL_VARIANT}_tp${TP}_ep${EP}_pp${PP}_before_refactor"
...
# --- Tokenizer ---
TOKENIZER_MODEL=${TOKENIZER_MODEL:-/lustre/fs1/portfolios/coreai/users/jinliangl/repos/hf_home/hub/models--Qwen--Qwen3.5-35B-A3B/snapshots/ec2d4ece1ffb563322cbee9a48fe0e3fcbce0307}
TOKENIZER_ARGS=(
...
MULTIMODAL_ARGS=(
    ...
    --hf-processor-path /lustre/fs1/portfolios/coreai/users/jinliangl/repos/hf_home/hub/models--Qwen--Qwen3.5-35B-A3B/snapshots/ec2d4ece1ffb563322cbee9a48fe0e3fcbce0307
