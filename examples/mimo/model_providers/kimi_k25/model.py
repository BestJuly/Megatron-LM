...
"""Kimi K2.5 Vision-Language model for Megatron-LM.
...
class KimiK25VLModel(MegatronModule):
    ...
    Args:
        ...
        pre_process: Whether this rank includes vision+embedding (PP first stage).
    """
    ...
    def __init__(
        ...
        # MegatronModule needs a config with transformer fields
        ...
        # Language model — key prefix: language_model.*
    ...
    def _extract_image_features(self, pixel_values, grid_thw):
        ...
        # May return list — ensure it's a list for merge logic
    ...
    def _merge_input_ids_with_image_features(
        ...
        # Dynamic expansion (inference) — not expected during training
        raise NotImplementedError(
            "Dynamic expansion mode not implemented in MIMO path. "
            "Ensure mock data pre-expands image placeholders."
        )

    # ------------------------------------------------------------------
    # Forward (mirrors Bridge)
    # ------------------------------------------------------------------
    def forward(
        self,
        ...
        # Return (output, loss_mask) to match MIMO train.py convention
