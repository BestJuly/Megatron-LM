# multimodal_v2 — Standalone Multimodal Training
...
```
multimodal_v2/models/llava_next/
├── __init__.py
...
```python
from multimodal_v2.models.llava_next.configuration import (
    get_llava_next_vision_config,
)
from multimodal_v2.models.llava_next.factory import (
...
MODEL_REGISTRY["llava_next"] = {
    ...
    "dataset_providers": {                                  # optional
        "mock": "multimodal_v2.data.llava_mock.train_valid_test_datasets_provider",
    },
}
```
