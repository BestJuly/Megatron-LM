...
# Launcher-ready command from job 711422; measured code: 4476895424269ad168e181cfd69beaec0701c71a.
...
MCORE_BENCH_OUTPUT="${MCORE_BENCH_OUTPUT:-$MCORE_ROOT/runtime/mdp_rebench/s4k_pp2ep64_decoder_single4096}"
...
cd "$MCORE_ROOT"
exec "$@" "$MCORE_ROOT/pretrain_gpt.py" \
    ...
    --num-workers 6 \
    --use-varlen-dataset \
    --varlen-mock-dataset-config-json "${MCORE_ROOT}/examples/multimodal_dev/doc/mdp/recipes/data/mock_fixed_4096.json" \
